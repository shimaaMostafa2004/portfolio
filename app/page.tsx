...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/og-image.jpg`, width: 1200, height: 630, alt: "عبدالرحمن طاهر - مطور Laravel وخبير Database" }],
  },
  twitter: {
...
const homeFaqs = [
  {
    ...
    answer:
      "عبدالرحمن طاهر مهندس برمجيات باك اند أول ومطور Laravel وخبير Database من مصر، يعمل عن بُعد مع شركات في مصر والخليج. متخصص في بناء REST APIs عالية الأداء وتحسين قواعد البيانات وتكامل بوابات الدفع والأنظمة السحابية. خبرة تتجاوز 5 سنوات في هندسة البرمجيات للشركات الإقليمية.",
  },
  {
    question: "ما هي خدمات هندسة الباك اند التي يقدمها عبدالرحمن طاهر؟",
    answer:
      "يقدم عبدالرحمن طاهر خدمات شاملة: تطوير Laravel وNode.js، بناء REST APIs، تحسين أداء Database، تكامل بوابات الدفع (Mada وMoyasar وTap وPaymob وStripe)، بناء الأنظمة السحابية بـ Docker وAWS، إعداد Redis Caching وQueue Workers، والاستشارات التقنية لمراجعة المعمارية البرمجية.",
  },
  {
  ...
  {
    question: "كيف يُحسّن عبدالرحمن طاهر أداء قواعد بيانات Database؟",
    answer:
      "يُحسّن عبدالرحمن طاهر أداء Database من خلال: تحليل خطط التنفيذ بـ EXPLAIN ANALYZE، بناء فهارس مركّبة ذكية، تقسيم الجداول الضخمة (Table Partitioning)، تحسين الاستعلامات الفرعية المعقدة، إعداد Connection Pooling، واستخدام Redis لتخفيف الضغط على قاعدة البيانات.",
  },
  {
...
export default function HomePage() {
  const schema = baseSchema(
    SITE_URL,
    "عبدالرحمن طاهر | مطور Laravel و Database",
    "عبدالرحمن طاهر، مطور Laravel وخبير Database في مصر والخليج. أبني REST APIs وأنظمة باك إند عالية الأداء مع تكامل بوابات الدفع وتحسين قواعد البيانات."
  );
